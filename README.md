...
A token is provided by the server to validate a user once they have signed in using the correct password.

- [ ] What steps can you take in your web apps to keep your data secure?

Authentication, encryption, hashing, private routing

- [ ] Describe how web servers work.

It listens for a request
depending on the request it will return a certain response
